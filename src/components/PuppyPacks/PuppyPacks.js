    ...
    return (
      <section className="PuppyPacks" id="PuppyPacks">
        <div className="inner">
          ...
          <p>At Muddy Pups we are more than happy to introduce puppies to being groomed and love nothing more than being able to sneak a quick cuddle too which is why we offer a specially adapted package purely for introducing puppies to being groomed.</p>
          ...
          <p><strong>3rd visit</strong> - Lets be honest and say this is where the magic begins to happen, we combine visits 1 and 2 and return to you a wonderfully cuddly and clean puppy for your family to love and adore.</p>
